...
var _user$project$Ports$clearToken = _elm_lang$core$Native_Platform.outgoingPort(
	'clearToken',
	function (v) {
		return v;
	});
var _user$project$Ports$getToken = _elm_lang$core$Native_Platform.incomingPort('getToken', _elm_lang$core$Json_Decode$value);
...
var _user$project$Types$encodeArticle = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'articleSlug',
				_1: _elm_lang$core$Json_Encode$string(x.articleSlug)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'articleTitle',
					_1: _elm_lang$core$Json_Encode$string(x.articleTitle)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'articleBody',
						_1: _elm_lang$core$Json_Encode$string(x.articleBody)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'articleAuthor',
							_1: _elm_lang$core$Json_Encode$string(x.articleAuthor)
						},
						_1: {
							ctor: '::',
							_0: {
...
var _user$project$Types$encodeSession = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'sessionId',
				_1: _elm_lang$core$Json_Encode$int(x.sessionId)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Types$Session = function (a) {
	return {sessionId: a};
};
var _user$project$Types$decodeSession = A3(
...
var _user$project$Types$Article = F5(
	function (a, b, c, d, e) {
		return {articleSlug: a, articleTitle: b, articleBody: c, articleAuthor: d, articleTags: e};
	});
...
var _user$project$Admin$url = 'https://e2ecd374-efa7-4edd-ae58-3ca2b9b72867.mock.pstmn.io/api/users/register';
var _user$project$Admin$Model = F5(
	function (a, b, c, d, e) {
		return {title: a, body: b, tags: c, error: d, userid: e};
	});
var _user$project$Admin$init = {
	ctor: '_Tuple2',
	_0: A5(_user$project$Admin$Model, '', '', '', _elm_lang$core$Maybe$Nothing, 123),
...
var _user$project$Admin$addArticleCmd = F2(
	function (userid, article) {
		return A2(
			...
			A2(_user$project$Types$postApiArticlesByUserid, userid, article));
	});
			...
			case 'SubmitArticle':
				return {
					...
					_1: A2(
						...
						1,
						A3(
							_user$project$Types$CreateArticle,
							model.title,
							model.body,
							{ctor: '[]'}))
				};
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$placeholder('add tags'),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Admin$Logout),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
...
var Elm = {};
Elm['Admin'] = Elm['Admin'] || {};
if (typeof _user$project$Admin$main !== 'undefined') {
    _user$project$Admin$main(Elm['Admin'], 'Admin', undefined);
}
