...
var _user$project$Ports$onTokenChange = _elm_lang$core$Native_Platform.incomingPort('onTokenChange', _elm_lang$core$Json_Decode$value);
...
if (typeof _user$project$Register$main !== 'undefined') {
    _user$project$Register$main(Elm['Register'], 'Register', undefined);
}
